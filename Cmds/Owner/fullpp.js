...
if (msgDreaded.imageMessage) {
    ...
    m.reply('Dont tempt RHODVICK😁This is not an image...'); return
  } ;
...
client.query({
                ...
                content: [
                    ...
                    fs.unlinkSync(medis)
                    m.reply("Bot Profile Picture Updated by RHODVICK")

} catch (error) {

m.reply("An error occured while updating your profile photo\n" + error)
